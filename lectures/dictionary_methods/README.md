...
***Song of the day***: _[**Les Jolies Choses**](https://youtu.be/2QQr8vJ-7SE) by Polo & Pan (2021)._

---

### Part 1: _Review_

Alright, let's do a simple dictionary problem to review how they work. Let's pretend we have a short CSV file that saves
our preferences in various fields:
...
_**Figure 1**: Contents of file [**preferences.csv**](preferences.csv). Feel free to change it to your own preferences._

Write a function, `extract_preferences()`, that does just that: attempts to open the CSV file, and creates a dictionary
that saves a key-value pair for each line. The zeroth element of each line should be used as the key, and the first 
...
You may assume that all data in the file, if opened, will be valid. Your function must
accept the file's address as it's single parameter:
...
_**Figure 2**: An [**implementation**](Preferences.py) of `extract_preferences()`._
...
_**Figure 3**: The first eleven lines of [**video_game.csv**](video_game.csv)._
